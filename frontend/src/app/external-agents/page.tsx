    ...
    <div className="fixed inset-0 bg-black/80 z-50 flex items-center justify-center p-4 backdrop-blur-sm">
      ...
      >
        ...
        <div className="bg-yellow-950/50 border border-yellow-800/60 rounded-xl px-4 py-3 mb-4 text-sm text-yellow-300 leading-relaxed">
          ...
          external agent environment. Enkstein stores only a hashed preview — the full secret cannot be retrieved after you close this dialog.
        </div>
    ...
    <div className="space-y-6">
      ...
      <div className="pb-4 border-b" style={{ borderColor: '#1e293b' }}>
        ...
        <p className="text-gray-400 mt-1 text-sm">
          Register and govern external agents under Enkstein Zero Trust architecture.
      ...
      <div className="rounded-2xl p-5" style={{ background: '#0f172a', border: '1px solid #1e293b' }}>
        ...
        <div className="flex items-start gap-3 overflow-x-auto pb-1">
          {[
            { icon: Globe,    color: 'text-cyan-400',   title: '1. Register',  body: 'Provide your HTTPS endpoint and declare scopes. Enkstein generates a signing secret.' },
            ...
            { icon: Shield,   color: 'text-purple-400', title: '3. Dispatch',  body: 'When run, Enkstein signs the payload with HMAC-SHA256 and calls your endpoint.' },
            { icon: Lock,     color: 'text-green-400',  title: '4. Verify',    body: 'Enkstein verifies X-Agent-Signature. Invalid signatures abort the run immediately.' },
