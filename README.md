...
Enkstein `0.7.0` provides three governed runtime paths on top of the compatibility platform:
...
Version `0.7.0` keeps a paired Browser Companion marked ready while it is
