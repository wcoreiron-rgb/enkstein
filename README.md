...
<p align="center">
  <a href="https://github.com/wcoreiron-rgb/enkstein/releases/latest/download/Enkstein-0.5.9-macos.pkg">
  ...
  &nbsp;
  <a href="https://github.com/wcoreiron-rgb/enkstein/releases/latest/download/Enkstein-0.5.9-windows-x64-setup.exe">
...
<p align="center">
  <sub>
    <b>v0.5.9</b> &nbsp;&middot;&nbsp; macOS 14+ (Apple silicon &amp; Intel), signed and notarized &nbsp;&middot;&nbsp;
...
Enkstein `0.5.9` provides three governed runtime paths on top of the compatibility platform:
...
Version `0.5.9` keeps a paired Browser Companion marked ready while it is
...
```bash
pip install ./enkstein_mcp-0.5.9-py3-none-any.whl
```
...
```bash
pip install ./enkstein_cli-0.5.9-py3-none-any.whl
...
```bash
pip install ./enkstein_core-0.5.9-py3-none-any.whl
```
```python
