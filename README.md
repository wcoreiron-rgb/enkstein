...
<p align="center">
  <sub>
    <b>Current release: v0.8.4</b> &nbsp;&middot;&nbsp; macOS 14+ (Apple silicon &amp; Intel), Developer ID signed and notarized &nbsp;&middot;&nbsp;
...
```bash
pip install ./enkstein_mcp-0.8.4-py3-none-any.whl
```
