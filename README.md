...
Enkstein `0.3.15` provides three governed runtime paths on top of the compatibility platform:
...
Version `0.3.15` also hardens the Model Cortex boundary: profile, audit, direct
