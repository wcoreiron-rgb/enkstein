...
<p align="center">
  <a href="https://github.com/wcoreiron-rgb/enkstein/releases/latest/download/Enkstein-0.6.5-macos.pkg">
  ...
  &nbsp;
  <a href="https://github.com/wcoreiron-rgb/enkstein/releases/latest/download/Enkstein-0.6.5-windows-x64-setup.exe">
...
<p align="center">
  <sub>
    <b>v0.6.5</b> &nbsp;&middot;&nbsp; macOS 14+ (Apple silicon &amp; Intel), signed and notarized &nbsp;&middot;&nbsp;
...
Enkstein `0.6.5` provides three governed runtime paths on top of the compatibility platform:
...
Version `0.6.5` keeps a paired Browser Companion marked ready while it is
...
```bash
pip install ./enkstein_mcp-0.6.5-py3-none-any.whl
```
...
```bash
pip install ./enkstein_cli-0.6.5-py3-none-any.whl
...
```bash
pip install ./enkstein_core-0.6.5-py3-none-any.whl
```
```python
