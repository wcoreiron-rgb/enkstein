...
Enkstein `0.3.16` provides three governed runtime paths on top of the compatibility platform:
...
Version `0.3.16` also hardens the Model Cortex boundary: profile, audit, direct
